            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="row">
                        @foreach($promotion_product as $pprod)
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="product.html"><img src="source/image/product/{{$pprod->image}}" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">{{$pprod->name}}</p>
                                        <p class="single-item-price" style="font-size: 18px">
                                            <span class="flash-del">{{$pprod->unit_price}}VND</span>
                                            <span class="flash-sale">{{$pprod->promotion_price}} VND</span>
                                        </p>
                                    </div>
                                    <div class="single-item-caption">
                                        <a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
